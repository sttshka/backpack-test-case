// https://github.com/gVguy/vue-follow-tooltip/blob/master/src/tooltip.js
...
class Tooltip {
  ...
  show(skipDelay) {
    if (this.state == "hidden") {
      ...
      this.el.style.width =
        Math.ceil(parseFloat(this.computedStyle.getPropertyValue("width"))) +
        "px";
      this.el.style.height =
        Math.ceil(parseFloat(this.computedStyle.getPropertyValue("height"))) +
        "px";
